...
<div id="page">
	<div class="container">
		...
		<div class="site-branding">
			<h1 class="site-title"><a href="index.html" rel="home">ECOSHAUR</a></h1>
			<h2 class="site-description">C2C Rental Service</h2>
		</div>
		...
		<div class="menu-menu-1-container">
			<ul id="menu-menu-1" class="menu">
				...
				<form id="content">
				<!-- 돋보기 아이콘(원형) -->
				<input type="text" name="input1" class="input1" id="search-input" border-top-width: 4px;">
				<!-- 돋보기 아이콘(막대기) -->			  
